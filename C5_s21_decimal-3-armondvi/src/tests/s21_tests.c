...
START_TEST(s21_test_decimal_add_16) {
  s21_decimal c = {{11, 0, 0, EXP_PLUS_1}};
  s21_decimal d = {{0, 0, 0, 0}};
  s21_decimal etalon = {{11, 0, 0, EXP_PLUS_1}};
...
START_TEST(s21_test_decimal_add_17) {
  s21_decimal c = {{11, 0, 0, EXP_PLUS_1}};
  s21_decimal d = {{1, 0, 0, 0}};
  s21_decimal etalon = {{21, 0, 0, EXP_PLUS_1}};
...
START_TEST(s21_test_decimal_add_18) {
  s21_decimal c = {{111, 0, 0, EXP_PLUS_1}};
  s21_decimal d = {{1, 0, 0, 0}};
  s21_decimal etalon = {{121, 0, 0, EXP_PLUS_1}};
...
START_TEST(s21_test_decimal_add_19) {
  s21_decimal c = {{111, 0, 0, EXP_PLUS_2}};
  s21_decimal d = {{1, 0, 0, 0}};
  s21_decimal etalon = {{1111, 0, 0, EXP_PLUS_2}};
...
START_TEST(div_5) {
  ...
  s21_setScale(&value_1, 1);
  s21_setScale(&value_2, 2);
...
START_TEST(floor_4) {
  float n = s21_rand(-8388608, 8388608);
...
START_TEST(from_decimal_to_float_4) {
  float n = s21_rand(-1e-6 / 3, 1e-6 / 3);
  s21_decimal var = {{0, 0, 0, 0}};
  float value = 0;
  s21_from_float_to_decimal(n, &var);
  s21_from_decimal_to_float(var, &value);
...
START_TEST(s21_test_from_decimal_to_int_11) {
  s21_decimal a = {{INT_MAX, 0, 0, EXP_PLUS_1}};
...
START_TEST(s21_test_from_decimal_to_int_14) {
  s21_decimal a = {{INT_MAX, 0, 0, EXP_PLUS_28}};
...
START_TEST(is_less_7) {
  ...
  s21_decimal val2 = {{0}};
  val2.bits[2] = 257;
  s21_setScale(&val1, 127);
  s21_setScale(&val2, 127);
  ck_assert_int_eq(1, s21_is_less(val1, val2));
}
END_TEST
...
START_TEST(is_less_13) {
  float a = s21_rand(-10e20, 10e20);
  float b = s21_rand(-10e20, 10e20);
...
START_TEST(sub_26) {
  ...
  s21_setScale(&value_1, 4);
  s21_decimal value_2 = {{5919, 0, 0, 0}};
  s21_setScale(&value_2, 1);
  s21_decimal result = {0};
  s21_decimal check = {{5854929, 0, 0, 0}};
  s21_setScale(&check, 4);
  s21_setSign(&check);
  int return_value = s21_sub(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
